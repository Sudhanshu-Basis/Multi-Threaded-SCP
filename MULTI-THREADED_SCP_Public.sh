...
script_help()
{
    ...
    echo ""
    echo "DIR_SOURCE::"
    echo " 	Provide the source directory for all files, make sure to have / at the end. e.g. - /sap_bkup/NLP/"
    echo "TARGET_USER::"
    ...
    echo "	Provide the directory name at the target host where you would like the files transferred, make sure to have / at the end. e.g. - /sap_bkup/NLQ/ "
    ...
    echo "	MULTI-THREADED_SCP.sh /sap_bkup/NLP/ nlqadm sapnlqdbq001.tas.nike.com /sap_bkup/NLQ/ 10 NLPIQDB_FULL"
    echo ""
	echo ""
    echo "OPTIONS:"
...
script_verify_ssh()
{
    ...
    then
       ...
       echo ""
       echo "Sorry, SSH is not configured between SAP hosts listed in the 'saphosts' file"
       echo ""
